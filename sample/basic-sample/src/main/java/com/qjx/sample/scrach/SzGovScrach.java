...
import com.qjx.sample.util.HttpUtil;
...
public class SzGovScrach {
    ...
    private static String child_Url = "http://spf.szfcweb.com/szfcweb/(S(prputvacw2gbrx4ghh2xovd1))/DataSerach/SaleInfoHouseView.aspx?SHSE_ID=%s";
